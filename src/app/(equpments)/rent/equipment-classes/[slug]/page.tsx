                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-3 gap-8 mb-6 max-w-md border-b border-gray-100 pb-6">
                                <div>
                                    <span className="text-2xl font-bold text-gray-900 block">{equipment.pricing?.day || "$-"}</span>
                                    <span className="text-sm text-gray-500 font-medium">/ day</span>
                                </div>
                                <div>
                                    <span className="text-2xl font-bold text-gray-900 block">{equipment.pricing?.week || "$-"}</span>
                                    <span className="text-sm text-gray-500 font-medium">/ week</span>
                                </div>
                                <div>
                                    <span className="text-2xl font-bold text-gray-900 block">{equipment.pricing?.fourWeek || "$-"}</span>
                            ...
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-10">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="flex items-center border border-gray-300 rounded-sm w-32 h-12">
                                        <button className="h-full px-3 text-gray-500 hover:text-primary transition-colors flex items-center justify-center">
